...
### Lecture 12: การประมวลผลภาพ

<b>หมายเหตุ :</b> เลกเชอร์นี้ไม่มีสไลด์ แต่จะใช้สมุดบันทึก Pluto แทน โปรแกรมใช้ Julia เพียงอย่างเดียวไม่มี Python
...
<p />สิ้นสุดเนื้อหาทั้งหมดของวิชานี้
