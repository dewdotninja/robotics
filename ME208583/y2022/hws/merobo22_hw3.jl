...
# ╔═╡ b749b5d8-2487-4df2-9b9a-caa98741b027
 using ControlSystems, Plots,PlutoUI

# ╔═╡ 5a5ee650-2998-11ed-3e50-75e55ea1e252
md"""
Revision 1: September 2022
"""

# ╔═╡ 71d8156a-2db4-44d8-aa68-2d59f2b4700b
md"""
!["Feng_head"](https://raw.githubusercontent.com/dewdotninja/exams/main/feng_heading_en.png)
...
# ╔═╡ 279beb4a-8f78-4873-b587-71258029d677


# ╔═╡ 8619141b-1036-47b0-9b9b-c2d40c48465f
md"""
#### Homework problem may depend on the last 3 digits of your student ID
...
For example,  z=8 y = 3 $\Rightarrow$ 12z7 = 1287, 4.3y5 = 4.335

Conditional statement may be used, such as
if x<5 do task A, otherwise do task B

*Example:* Let $R1 = 1000*x \,\Omega, C1 = 10*y \,\mu F$


* Student A (x=8, y=5) does this problem with R1 = 8000 $\Omega$, C1 = 50 $\mu$F
* Student B (x=1, y=5) does this problem with R1 = 1000 $\Omega$, C1 = 50 $\mu$F
* Student C (x=5, y=3) does this problem with R1 = 5000 $\Omega$, C1 = 30 $\mu$F

"""

# ╔═╡ 2a541513-d495-4483-b8a6-f731cb0f8f4e
md"""
...
# ╔═╡ 77561204-cee3-4651-8b11-0344ac16f11f
md"""
### (from Homework 2)
...
Figure 1 HDM structure (https://www.harmonicdrive.net/)
...
#### (copy code from your homework 2)

"""

# ╔═╡ a43da29e-e814-4d85-8479-e341b9956ccf


# ╔═╡ 5cc79d4e-2f9e-4593-b45f-4a3b7d9a8f77


# ╔═╡ fb7fcb7a-fd37-4d46-a015-11d56505884b
md"""
#### P 1 (10 points) 

Figure 3 shows cascaded PID structure (for a robot joint driven by simple DC motor) to improve closed-loop performance.  

!["Fig 3"](https://drive.google.com/uc?id=1uUQjWyLEXP1XmwUTk5KpU6Tcr84k61G7)

Figure 3 cascaded PID control 

Extract the integrator from the HDM plant from P1 to use it in the outer loop as shown in Figure 3. The rest of the plant transfer function is in the inner-loop. For both loops, use the following PID equation 
...
2. Suppose we want to cast the specifications from HW3 so that loopshaping procedure can be performed (with adjustable PID parameters instead of zeros/pole. Determine the resulting transfer function $C(s)$ and $P(s)$ used as arguments for lshape() (4 points)
3. Adjust PID parameters to conform to the specifications in your HW3 (2 points). 

#### Solution

"""

# ╔═╡ d88c506e-cc92-475a-bd1b-51e7b64871ce


# ╔═╡ 48cd3183-c59c-48da-a225-b8d0623af60a


# ╔═╡ d6f6dc09-bd61-440a-945b-8396a6837f7a


# ╔═╡ 52613908-bd17-4480-abf4-b0159be518af


# ╔═╡ dd86f69e-6a17-4ce3-a6ca-71e2777dc49e


# ╔═╡ a248bb7e-cdd8-49d5-bff7-b62cc898f370


# ╔═╡ b3f1da87-256a-42f5-997a-b0f9eb325fe6


# ╔═╡ 4cb743bd-0b6d-4180-8f4e-9456b21c361b


# ╔═╡ a82b6ade-90d4-4bb2-9ade-990f5b52fd60
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "2f99fb1963f7f7953854fde10bb3187352e9450f"
...
[[deps.ControlSystems]]
deps = ["Colors", "DSP", "DelayDiffEq", "DiffEqCallbacks", "ForwardDiff", "IterTools", "LaTeXStrings", "LinearAlgebra", "MacroTools", "MatrixEquations", "MatrixPencils", "OrdinaryDiffEq", "Polyester", "Polynomials", "Printf", "Random", "RecipesBase", "SparseArrays", "StaticArrays", "UUIDs"]
git-tree-sha1 = "4c1dec2e8a67c02d50221da81005616d46c3de2d"
