...
!["Fig1"](https://drive.google.com/uc?id=1ptbNZTWM-39go6f8nHEW36cmfd7o6h_D)
Figure 1 Scilab/Xcos diagram for output disturbance attenuation

Create similar simulation setup in Julia using the same plant and controller as in Figure 1; i.e.,
...
If  ControlSystems is not installed, uncomment the cell below
"""
...
plot_response(?,uvec,tvec) # Replace ? with the right closed-loop transfer function
...
plot_response(?,uvec2,tvec) # # Replace ? with the right closed-loop transfer function
...
git-tree-sha1 = "b9db97ff2391603bb6411ae8a87258055e2c7de5"
